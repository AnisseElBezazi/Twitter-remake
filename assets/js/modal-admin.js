//A changer y a beaucoup plus simple sans JS
  ...
  fetch('process/is_admin.php')
    ...
    .then((data) => {
      if (data.is_admin) {
        ...
        btn.style =
          'margin: 16px 0 0 0; background: #e50914; color: #fff; border: none; border-radius: 6px; padding: 8px 18px; font-size: 1rem; cursor: pointer;';
        ...
        document.querySelectorAll('.admin-delete-movie-btn').forEach((btn) => {
          ...
          btn.addEventListener('click', function (e) {
            ...
            window.location.href =
              'process/delete_movie_process.php?id=' + this.getAttribute('data-id');
          });
        });
      }
    });
